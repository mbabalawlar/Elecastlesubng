...
class DataReceipt extends StatefulWidget {
  Map data;
  DataReceipt({this.data});

  @override
  _DataReceiptState createState() => _DataReceiptState();
}

class _DataReceiptState extends State<DataReceipt> {
  bool token = false;
  ...
  Future<void> generateExampleDocument() async {
   ...
   <!DOCTYPE html>
    <html>
     ...
     <center>  <h2> elecastlesubng Data Subscription Receipt</h2></center>  
  ...
  <tr>
    ...
    <tr>
      ...
      <td><b>Plan</b></td>
      <td > <span></span><span id="paid">${widget.data['plan_name']}</span></td>
  </tr>
  ...
  <tr>
    ...
    var targetFileName = "DataReceipt$randomNumber";
