...
class _MyReferalState extends State<MyReferal> {
  ...
  Future fetchhistory() async {
    ...
    try {
      final url = 'https://www.elecastlesubng.com/api/referal/';
              ...
              Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      Center(
                        child: Text(
                          "elecastlesubng Referal program",
                          style: TextStyle(
                      ...
                      Text(
                        "Refer people to elecastle and earn ₦500 immediately the person upgrade his/her account to affiliate or topuser.",
