...
class _CableSState extends State<CableS> {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        if (this.mounted) {
          setState(() {
            ...
            if (customername != "NO NAME RETURN") {
              validate = true;
            } else {
              Toast.show("NO NAME RETURN", context,
  ...
  Future<dynamic> _cableSubmit(String cablename, String cableplan, String meter,
    ...
    return InkWell(
      onTap: () async {
        if (_formKey.currentState.validate()) {
          ...
          await _cableSubmit(widget.id.toString(), _myActivity,
              _meterController.text, customername);
        }
      },
      child: Container(
